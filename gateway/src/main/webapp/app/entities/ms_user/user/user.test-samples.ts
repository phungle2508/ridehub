...
export const sampleWithRequiredData: IUser = {
  ...
  createdAt: dayjs('2025-08-29T05:34'),
  updatedAt: dayjs('2025-08-29T13:02'),
...
export const sampleWithPartialData: IUser = {
  ...
  createdAt: dayjs('2025-08-29T06:38'),
  updatedAt: dayjs('2025-08-29T05:32'),
...
export const sampleWithFullData: IUser = {
  ...
  dateOfBirth: dayjs('2025-08-29'),
  createdAt: dayjs('2025-08-29T19:27'),
  updatedAt: dayjs('2025-08-29T08:17'),
...
export const sampleWithNewData: NewUser = {
  ...
  lastName: 'Fisher',
  phoneNumber: 'yahoo',
  createdAt: dayjs('2025-08-29T20:23'),
  updatedAt: dayjs('2025-08-29T08:03'),
