...
describe('Payment Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '9f9adfb8-920e-430f-9f2c-915c96a25fe5' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'cc9d6dd1-de23-472f-b822-0a0f45df3beb' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.payments()[0]).toEqual(expect.objectContaining({ id: '9f9adfb8-920e-430f-9f2c-915c96a25fe5' }));
  });

  describe('trackId', () => {
    it('should forward to paymentService', () => {
      const entity = { id: '9f9adfb8-920e-430f-9f2c-915c96a25fe5' };
