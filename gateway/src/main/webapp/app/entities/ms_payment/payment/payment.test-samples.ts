...
export const sampleWithRequiredData: IPayment = {
  ...
  paymentMethod: 'even',
  status: 'REFUNDED',
  createdAt: dayjs('2025-08-29T01:19'),
  updatedAt: dayjs('2025-08-29T08:24'),
};
...
export const sampleWithPartialData: IPayment = {
  ...
  createdAt: dayjs('2025-08-29T17:19'),
  updatedAt: dayjs('2025-08-29T09:55'),
};
...
export const sampleWithFullData: IPayment = {
  ...
  paymentGatewayResponse: '../fake-data/blob/hipster.txt',
  createdAt: dayjs('2025-08-29T02:53'),
  updatedAt: dayjs('2025-08-29T06:14'),
};
...
export const sampleWithNewData: NewPayment = {
  ...
  status: 'FAILED',
  createdAt: dayjs('2025-08-29T10:24'),
  updatedAt: dayjs('2025-08-29T15:02'),
  id: null,
};
