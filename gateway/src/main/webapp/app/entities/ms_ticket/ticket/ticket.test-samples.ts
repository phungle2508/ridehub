...
export const sampleWithRequiredData: ITicket = {
  ...
  price: 29866.34,
  status: 'EXPIRED',
  createdAt: dayjs('2025-08-29T21:17'),
  updatedAt: dayjs('2025-08-29T03:00'),
};
...
export const sampleWithPartialData: ITicket = {
  ...
  price: 30556.66,
  status: 'CANCELLED',
  reservedUntil: dayjs('2025-08-29T07:24'),
  createdAt: dayjs('2025-08-29T03:07'),
  updatedAt: dayjs('2025-08-29T03:49'),
};
...
export const sampleWithFullData: ITicket = {
  ...
  price: 22086.89,
  status: 'EXPIRED',
  reservedUntil: dayjs('2025-08-29T20:30'),
  createdAt: dayjs('2025-08-29T05:48'),
  updatedAt: dayjs('2025-08-29T02:42'),
};
...
export const sampleWithNewData: NewTicket = {
  ...
  price: 11316.97,
  status: 'EXPIRED',
  createdAt: dayjs('2025-08-29T06:21'),
  updatedAt: dayjs('2025-08-29T12:32'),
  id: null,
};
