...
export const sampleWithRequiredData: INotification = {
  ...
  isRead: true,
  createdAt: dayjs('2025-08-29T08:29'),
};
...
export const sampleWithPartialData: INotification = {
  ...
  message: '../fake-data/blob/hipster.txt',
  isRead: false,
  createdAt: dayjs('2025-08-29T19:45'),
  scheduledAt: dayjs('2025-08-29T13:22'),
};
...
export const sampleWithFullData: INotification = {
  ...
  createdAt: dayjs('2025-08-29T11:53'),
  scheduledAt: dayjs('2025-08-29T14:33'),
};
...
export const sampleWithNewData: NewNotification = {
  ...
  message: '../fake-data/blob/hipster.txt',
  isRead: false,
  createdAt: dayjs('2025-08-29T02:38'),
  id: null,
};
