...
import com.ticketsystem.route.service.OperatorQueryService;
...
/**
 * REST controller for managing {@link com.ticketsystem.route.domain.Operator}.
 */
@RestController
...
public class OperatorResource {
    ...
    private static final String ENTITY_NAME = "msRouteOperator";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<OperatorDTO>> getAllOperators(OperatorCriteria criteria) {
        LOG.debug("REST request to get Operators by criteria: {}", criteria);

        List<OperatorDTO> entityList = operatorQueryService.findByCriteria(criteria);
