...
/**
 * Criteria class for the {@link com.ridehub.booking.domain.FileBooking} entity. This class is used
 * in {@link com.ridehub.booking.web.rest.FileBookingResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /file-bookings?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FileBookingCriteria implements Serializable, Criteria {
    ...
    public FileBookingCriteria() {}

    public FileBookingCriteria(FileBookingCriteria other) {
    ...
    @Override
    public FileBookingCriteria copy() {
        return new FileBookingCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FileBookingCriteria that = (FileBookingCriteria) o;
        return (
