...
public class PaymentWebhookLog implements Serializable {
    ...
    @NotNull
    @Column(name = "payload_hash", nullable = false, unique = true)
    ...
    public PaymentWebhookLog provider(String provider) {
    ...
    public PaymentWebhookLog payloadHash(String payloadHash) {
        this.setPayloadHash(payloadHash);
        return this;
    }
    ...
    public PaymentWebhookLog processingStatus(String processingStatus) {
    ...
    public PaymentWebhookLog updatedAt(Instant updatedAt) {
    ...
    public PaymentWebhookLog isDeleted(Boolean isDeleted) {
    ...
    public PaymentWebhookLog deletedAt(Instant deletedAt) {
    ...
    public PaymentWebhookLog deletedBy(UUID deletedBy) {
