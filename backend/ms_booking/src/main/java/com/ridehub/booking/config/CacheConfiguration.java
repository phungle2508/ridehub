...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(
        ...
        return cm -> {
            ...
            createCache(cm, com.ridehub.booking.domain.Booking.class.getName() + ".pricingSnapshots",
                    jcacheConfiguration);
            ...
            createCache(cm, com.ridehub.booking.domain.PaymentTransaction.class.getName() + ".webhooks",
                    jcacheConfiguration);
