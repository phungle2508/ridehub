...
public class FileBookingTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static FileBooking getFileBookingSample1() {
    ...
    public static FileBooking getFileBookingSample2() {
        return new FileBooking()
            .id(2L)
            .bucket("bucket2")
    ...
    public static FileBooking getFileBookingRandomSampleGenerator() {
        return new FileBooking()
