...
/**
 * REST controller for managing {@link com.ridehub.promotion.domain.ConditionRouteItem}.
 */
@RestController
...
public class ConditionRouteItemResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new conditionRouteItemDTO, or with status {@code 400 (Bad Request)} if the conditionRouteItem has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("")
    public ResponseEntity<ConditionRouteItemDTO> createConditionRouteItem(@Valid @RequestBody ConditionRouteItemDTO conditionRouteItemDTO)
        throws URISyntaxException {
        LOG.debug("REST request to save ConditionRouteItem : {}", conditionRouteItemDTO);
        if (conditionRouteItemDTO.getId() != null) {
            throw new BadRequestAlertException("A new conditionRouteItem cannot already have an ID", ENTITY_NAME, "idexists");
        }
        ...
        return ResponseEntity.created(new URI("/api/condition-route-items/" + conditionRouteItemDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, conditionRouteItemDTO.getId().toString()))
            .body(conditionRouteItemDTO);
    }

    /**
     * {@code PUT  /condition-route-items/:id} : Updates an existing conditionRouteItem.
     *
     * @param id the id of the conditionRouteItemDTO to save.
     * @param conditionRouteItemDTO the conditionRouteItemDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated conditionRouteItemDTO,
     * or with status {@code 400 (Bad Request)} if the conditionRouteItemDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the conditionRouteItemDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    public ResponseEntity<ConditionRouteItemDTO> updateConditionRouteItem(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, conditionRouteItemDTO.getId().toString()))
            .body(conditionRouteItemDTO);
    }

    /**
     * {@code PATCH  /condition-route-items/:id} : Partial updates given fields of an existing conditionRouteItem, field will ignore if it is null
     *
     * @param id the id of the conditionRouteItemDTO to save.
     * @param conditionRouteItemDTO the conditionRouteItemDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated conditionRouteItemDTO,
     * or with status {@code 400 (Bad Request)} if the conditionRouteItemDTO is not valid,
     * or with status {@code 404 (Not Found)} if the conditionRouteItemDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the conditionRouteItemDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<ConditionRouteItemDTO> partialUpdateConditionRouteItem(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody ConditionRouteItemDTO conditionRouteItemDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, conditionRouteItemDTO.getId().toString())
        );
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of conditionRouteItems in body.
     */
    @GetMapping("")
    ...
    /**
     * {@code GET  /condition-route-items/count} : count all the conditionRouteItems.
     *
     * @param criteria the criteria which the requested entities should match.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the conditionRouteItemDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
    ...
    /**
     * {@code DELETE  /condition-route-items/:id} : delete the "id" conditionRouteItem.
     *
