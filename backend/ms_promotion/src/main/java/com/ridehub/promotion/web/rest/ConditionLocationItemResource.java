 ...
 * {@link com.ridehub.promotion.domain.ConditionLocationItem}.
 */
@RestController
...
public class ConditionLocationItemResource {
     ...
     *         body the new conditionLocationItemDTO, or with status
     *         {@code 400 (Bad Request)} if the conditionLocationItem has already an
     *         ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("")
    public ResponseEntity<ConditionLocationItemDTO> createConditionLocationItem(
            @Valid @RequestBody ConditionLocationItemDTO conditionLocationItemDTO) throws URISyntaxException {
        LOG.debug("REST request to save ConditionLocationItem : {}", conditionLocationItemDTO);
        if (conditionLocationItemDTO.getId() != null) {
            throw new BadRequestAlertException("A new conditionLocationItem cannot already have an ID", ENTITY_NAME,
                    "idexists");
        }
        ...
        return ResponseEntity.created(new URI("/api/condition-location-items/" + conditionLocationItemDTO.getId()))
                .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME,
                        conditionLocationItemDTO.getId().toString()))
                .body(conditionLocationItemDTO);
    }

    /**
     * {@code PUT  /condition-location-items/:id} : Updates an existing
     * conditionLocationItem.
     *
     * @param id                       the id of the conditionLocationItemDTO to
     *                                 save.
     * @param conditionLocationItemDTO the conditionLocationItemDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the updated conditionLocationItemDTO,
     *         or with status {@code 400 (Bad Request)} if the
     *         conditionLocationItemDTO is not valid,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         conditionLocationItemDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    ...
    /**
     * {@code PATCH  /condition-location-items/:id} : Partial updates given fields
     * of an existing conditionLocationItem, field will ignore if it is null
     *
     * @param id                       the id of the conditionLocationItemDTO to
     *                                 save.
     * @param conditionLocationItemDTO the conditionLocationItemDTO to update.
     ...
     *         conditionLocationItemDTO is not found,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         conditionLocationItemDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<ConditionLocationItemDTO> partialUpdateConditionLocationItem(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody ConditionLocationItemDTO conditionLocationItemDTO) throws URISyntaxException {
        LOG.debug("REST request to partial update ConditionLocationItem partially : {}, {}", id,
        ...
        Optional<ConditionLocationItemDTO> result = conditionLocationItemService
                .partialUpdate(conditionLocationItemDTO);
     ...
     *         of conditionLocationItems in body.
     */
    @GetMapping("")
    public ResponseEntity<List<ConditionLocationItemDTO>> getAllConditionLocationItems(
            ConditionLocationItemCriteria criteria) {
    ...
    /**
     * {@code GET  /condition-location-items/count} : count all the
     * conditionLocationItems.
     *
     * @param criteria the criteria which the requested entities should match.
    ...
    /**
     * {@code GET  /condition-location-items/:id} : get the "id"
     * conditionLocationItem.
     *
     * @param id the id of the conditionLocationItemDTO to retrieve.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the conditionLocationItemDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
    ...
    /**
     * {@code DELETE  /condition-location-items/:id} : delete the "id"
     * conditionLocationItem.
     *
