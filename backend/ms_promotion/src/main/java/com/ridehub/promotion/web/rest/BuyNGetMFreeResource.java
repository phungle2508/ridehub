...
import com.ridehub.msroute.client.api.StationResourceMsrouteApi;
 ...
 * {@link com.ridehub.promotion.domain.BuyNGetMFree}.
 */
@RestController
...
public class BuyNGetMFreeResource {
    ...
    private final StationResourceMsrouteApi stationResourceMsrouteApi;

    public BuyNGetMFreeResource(
            BuyNGetMFreeService buyNGetMFreeService,
            BuyNGetMFreeRepository buyNGetMFreeRepository,
            BuyNGetMFreeQueryService buyNGetMFreeQueryService, StationResourceMsrouteApi stationResourceMsrouteApi) {
        ...
        this.stationResourceMsrouteApi = stationResourceMsrouteApi;
    }
     ...
     *         body the new buyNGetMFreeDTO, or with status
     *         {@code 400 (Bad Request)} if the buyNGetMFree has already an ID.
     ...
     *         the updated buyNGetMFreeDTO,
     *         or with status {@code 400 (Bad Request)} if the buyNGetMFreeDTO is
     *         not valid,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         buyNGetMFreeDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    public ResponseEntity<BuyNGetMFreeDTO> updateBuyNGetMFree(
            @PathVariable(value = "id", required = false) final Long id,
            @Valid @RequestBody BuyNGetMFreeDTO buyNGetMFreeDTO) throws URISyntaxException {
    ...
    /**
     * {@code PATCH  /buy-n-get-m-frees/:id} : Partial updates given fields of an
     * existing buyNGetMFree, field will ignore if it is null
     *
     * @param id              the id of the buyNGetMFreeDTO to save.
     * @param buyNGetMFreeDTO the buyNGetMFreeDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     ...
     *         or with status {@code 400 (Bad Request)} if the buyNGetMFreeDTO is
     *         not valid,
     *         or with status {@code 404 (Not Found)} if the buyNGetMFreeDTO is not
     *         found,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         buyNGetMFreeDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
    ...
    public ResponseEntity<BuyNGetMFreeDTO> partialUpdateBuyNGetMFree(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody BuyNGetMFreeDTO buyNGetMFreeDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the buyNGetMFreeDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
    public ResponseEntity<BuyNGetMFreeDTO> getBuyNGetMFree(@PathVariable("id") Long id) {
        ...
        System.out.println(stationResourceMsrouteApi.getStationsWithRoutesAndId(1500L, null));
