...
/**
 * Criteria class for the {@link com.ridehub.promotion.domain.ConditionByRoute} entity. This class is used
 * in {@link com.ridehub.promotion.web.rest.ConditionByRouteResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /condition-by-routes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ConditionByRouteCriteria implements Serializable, Criteria {
    ...
    public ConditionByRouteCriteria() {}
    ...
    @Override
    public ConditionByRouteCriteria copy() {
        return new ConditionByRouteCriteria(this);
    }
