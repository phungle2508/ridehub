...
public class PromotionPolicyConditionResource {
    ...
    public ResponseEntity<BuyNGetMFreeDTO> createBuyNGetMFreePolicy(
        ...
        if (buyNGetMFreeDTO.getId() != null) {
            throw new BadRequestAlertException("A new buyNGetMFree cannot already have an ID", "buyNGetMFree",
                    "idexists");
        }
        ...
        return ResponseEntity
                .created(new URI("/api/promotions/" + promotionId + "/buy-n-get-m-free/" + buyNGetMFreeDTO.getId()))
    ...
    public ResponseEntity<List<BuyNGetMFreeDTO>> getBuyNGetMFreePolicies(@PathVariable Long promotionId) {
        ...
        criteria.setPromotionId((tech.jhipster.service.filter.LongFilter) new tech.jhipster.service.filter.LongFilter()
    ...
    public ResponseEntity<Void> deleteBuyNGetMFreePolicy(@PathVariable Long promotionId, @PathVariable Long id) {
        ...
        return ResponseEntity.noContent()
                .headers(HeaderUtil.createEntityDeletionAlert(applicationName, true, "buyNGetMFree", id.toString()))
                .build();
    }
    ...
    public ResponseEntity<PercentOffTotalDTO> createPercentOffTotalPolicy(
            ...
            throws URISyntaxException {
        LOG.debug("REST request to save PercentOffTotal for promotion : {}, {}", promotionId, percentOffTotalDTO);
        ...
        if (percentOffTotalDTO.getId() != null) {
            throw new BadRequestAlertException("A new percentOffTotal cannot already have an ID", "percentOffTotal",
                    "idexists");
        }
        ...
        return ResponseEntity
                .created(new URI("/api/promotions/" + promotionId + "/percent-off-total/" + percentOffTotalDTO.getId()))
    ...
    public ResponseEntity<Void> deletePercentOffTotalPolicy(@PathVariable Long promotionId, @PathVariable Long id) {
        ...
        return ResponseEntity.noContent()
                .headers(HeaderUtil.createEntityDeletionAlert(applicationName, true, "percentOffTotal", id.toString()))
                .build();
    }
    ...
    public ResponseEntity<ConditionByDateDTO> createDateCondition(
            ...
            throws URISyntaxException {
        LOG.debug("REST request to save ConditionByDate for promotion : {}, {}", promotionId, conditionByDateDTO);
        ...
        if (conditionByDateDTO.getId() != null) {
            throw new BadRequestAlertException("A new conditionByDate cannot already have an ID", "conditionByDate",
                    "idexists");
        }
        ...
        return ResponseEntity
                .created(new URI("/api/promotions/" + promotionId + "/conditions/date/" + conditionByDateDTO.getId()))
    ...
    public ResponseEntity<Void> deleteDateCondition(@PathVariable Long promotionId, @PathVariable Long id) {
        ...
        return ResponseEntity.noContent()
                .headers(HeaderUtil.createEntityDeletionAlert(applicationName, true, "conditionByDate", id.toString()))
                .build();
    }
    ...
    public ResponseEntity<ConditionByRouteDTO> createRouteCondition(
            ...
            throws URISyntaxException {
        LOG.debug("REST request to save ConditionByRoute for promotion : {}, {}", promotionId, conditionByRouteDTO);
        ...
        if (conditionByRouteDTO.getId() != null) {
            throw new BadRequestAlertException("A new conditionByRoute cannot already have an ID", "conditionByRoute",
                    "idexists");
        }
        ...
        return ResponseEntity
                .created(new URI("/api/promotions/" + promotionId + "/conditions/route/" + conditionByRouteDTO.getId()))
    ...
    public ResponseEntity<Void> deleteRouteCondition(@PathVariable Long promotionId, @PathVariable Long id) {
        ...
        return ResponseEntity.noContent()
                .headers(HeaderUtil.createEntityDeletionAlert(applicationName, true, "conditionByRoute", id.toString()))
                .build();
    }
    ...
    public ResponseEntity<ConditionByLocationDTO> createLocationCondition(
        ...
        return ResponseEntity
                .created(new URI(
                        "/api/promotions/" + promotionId + "/conditions/location/" + conditionByLocationDTO.getId()))
                .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, "conditionByLocation",
    ...
    public ResponseEntity<ConditionByLocationDTO> updateLocationCondition(
            ...
            @Valid @org.springframework.web.bind.annotation.RequestBody ConditionByLocationDTO conditionByLocationDTO)
            throws URISyntaxException {
        LOG.debug("REST request to update ConditionByLocation : {}, {}, {}", promotionId, id, conditionByLocationDTO);
        ...
        return ResponseEntity.ok()
                .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, "conditionByLocation",
                        conditionByLocationDTO.getId().toString()))
                .body(conditionByLocationDTO);
    }
    ...
    public ResponseEntity<Void> deleteLocationCondition(@PathVariable Long promotionId, @PathVariable Long id) {
        ...
        return ResponseEntity.noContent()
                .headers(HeaderUtil.createEntityDeletionAlert(applicationName, true, "conditionByLocation",
                        id.toString()))
                .build();
    }
