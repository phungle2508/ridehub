...
/**
 * Criteria class for the {@link com.ridehub.promotion.domain.FilePromotion} entity. This class is used
 * in {@link com.ridehub.promotion.web.rest.FilePromotionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /file-promotions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FilePromotionCriteria implements Serializable, Criteria {
    ...
    public FilePromotionCriteria() {}

    public FilePromotionCriteria(FilePromotionCriteria other) {
    ...
    @Override
    public FilePromotionCriteria copy() {
        return new FilePromotionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FilePromotionCriteria that = (FilePromotionCriteria) o;
        return (
