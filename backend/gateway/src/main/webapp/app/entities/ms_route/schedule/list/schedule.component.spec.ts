...
import { sampleWithRequiredData } from '../schedule.test-samples';
...
describe('Schedule Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '5c834510-7171-4d53-a4b0-b1d5e8245594' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '06daa4d3-a4db-40fe-8685-fc15320e015f' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.schedules()[0]).toEqual(expect.objectContaining({ id: '5c834510-7171-4d53-a4b0-b1d5e8245594' }));
  });

  describe('trackId', () => {
    it('should forward to scheduleService', () => {
      const entity = { id: '5c834510-7171-4d53-a4b0-b1d5e8245594' };
