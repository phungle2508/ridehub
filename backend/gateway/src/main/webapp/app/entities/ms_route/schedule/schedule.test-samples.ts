...
export const sampleWithRequiredData: ISchedule = {
  ...
  departureTime: dayjs('2025-08-30T11:56'),
  arrivalTime: dayjs('2025-08-31T03:35'),
  totalSeats: 15364,
  availableSeats: 27871,
  basePrice: 24516.89,
  isActive: true,
  createdAt: dayjs('2025-08-30T22:13'),
  updatedAt: dayjs('2025-08-31T09:52'),
};
...
export const sampleWithPartialData: ISchedule = {
  ...
  departureTime: dayjs('2025-08-30T21:52'),
  arrivalTime: dayjs('2025-08-30T22:49'),
  totalSeats: 5209,
  availableSeats: 31832,
  basePrice: 10123.1,
  isActive: true,
  createdAt: dayjs('2025-08-31T03:57'),
  updatedAt: dayjs('2025-08-30T12:14'),
};
...
export const sampleWithFullData: ISchedule = {
  ...
  departureTime: dayjs('2025-08-30T23:56'),
  arrivalTime: dayjs('2025-08-30T22:35'),
  totalSeats: 3321,
  availableSeats: 9569,
  basePrice: 23696.08,
  isActive: false,
  createdAt: dayjs('2025-08-31T01:23'),
  updatedAt: dayjs('2025-08-31T08:37'),
};

export const sampleWithNewData: NewSchedule = {
  routeId: '47d5fe6f-4e76-470b-9c49-a7902c848590',
  departureTime: dayjs('2025-08-31T01:27'),
  arrivalTime: dayjs('2025-08-31T07:43'),
  totalSeats: 3825,
  availableSeats: 4545,
  basePrice: 26942.44,
  isActive: true,
  createdAt: dayjs('2025-08-31T00:18'),
  updatedAt: dayjs('2025-08-31T02:46'),
  id: null,
};
