...
export const sampleWithRequiredData: ISchedule = {
  ...
  departureTime: dayjs('2025-08-29T01:43'),
  arrivalTime: dayjs('2025-08-29T17:23'),
  totalSeats: 15364,
  availableSeats: 27871,
  basePrice: 24516.89,
  isActive: true,
  createdAt: dayjs('2025-08-29T12:00'),
  updatedAt: dayjs('2025-08-29T23:40'),
};
...
export const sampleWithPartialData: ISchedule = {
  ...
  departureTime: dayjs('2025-08-29T11:39'),
  arrivalTime: dayjs('2025-08-29T12:37'),
  totalSeats: 5209,
  availableSeats: 31832,
  basePrice: 10123.1,
  isActive: true,
  createdAt: dayjs('2025-08-29T17:45'),
  updatedAt: dayjs('2025-08-29T02:01'),
};
...
export const sampleWithFullData: ISchedule = {
  ...
  departureTime: dayjs('2025-08-29T13:43'),
  arrivalTime: dayjs('2025-08-29T12:22'),
  totalSeats: 3321,
  availableSeats: 9569,
  basePrice: 23696.08,
  isActive: false,
  createdAt: dayjs('2025-08-29T15:11'),
  updatedAt: dayjs('2025-08-29T22:24'),
};

export const sampleWithNewData: NewSchedule = {
  routeId: '47d5fe6f-4e76-470b-9c49-a7902c848590',
  departureTime: dayjs('2025-08-29T15:14'),
  arrivalTime: dayjs('2025-08-29T21:30'),
  totalSeats: 3825,
  availableSeats: 4545,
  basePrice: 26942.44,
  isActive: true,
  createdAt: dayjs('2025-08-29T14:05'),
  updatedAt: dayjs('2025-08-29T16:33'),
  id: null,
};
