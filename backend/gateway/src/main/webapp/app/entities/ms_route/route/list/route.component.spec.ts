...
describe('Route Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '49e2c511-948a-4381-a293-ae53a33bea8e' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'b1c399a0-817d-4c04-ae0b-b97422c251aa' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.routes()[0]).toEqual(expect.objectContaining({ id: '49e2c511-948a-4381-a293-ae53a33bea8e' }));
  });
