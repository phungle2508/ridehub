...
export const sampleWithRequiredData: INotification = {
  ...
  isRead: true,
  createdAt: dayjs('2025-08-29T08:32'),
};
...
export const sampleWithPartialData: INotification = {
  ...
  message: '../fake-data/blob/hipster.txt',
  isRead: false,
  createdAt: dayjs('2025-08-29T19:48'),
  scheduledAt: dayjs('2025-08-29T13:25'),
};
...
export const sampleWithFullData: INotification = {
  ...
  createdAt: dayjs('2025-08-29T11:56'),
  scheduledAt: dayjs('2025-08-29T14:36'),
};
...
export const sampleWithNewData: NewNotification = {
  ...
  message: '../fake-data/blob/hipster.txt',
  isRead: false,
  createdAt: dayjs('2025-08-29T02:41'),
  id: null,
};
