...
export const sampleWithRequiredData: IUser = {
  ...
  createdAt: dayjs('2025-08-30T15:50'),
  updatedAt: dayjs('2025-08-30T23:17'),
...
export const sampleWithPartialData: IUser = {
  ...
  createdAt: dayjs('2025-08-30T16:54'),
  updatedAt: dayjs('2025-08-30T15:48'),
...
export const sampleWithFullData: IUser = {
  ...
  dateOfBirth: dayjs('2025-08-31'),
  createdAt: dayjs('2025-08-31T05:43'),
  updatedAt: dayjs('2025-08-30T18:33'),
...
export const sampleWithNewData: NewUser = {
  ...
  lastName: 'Fisher',
  phoneNumber: 'yahoo',
  createdAt: dayjs('2025-08-31T06:39'),
  updatedAt: dayjs('2025-08-30T18:19'),
