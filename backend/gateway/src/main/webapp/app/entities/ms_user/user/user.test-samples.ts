...
export const sampleWithRequiredData: IUser = {
  ...
  createdAt: dayjs('2025-08-29T18:49'),
  updatedAt: dayjs('2025-08-30T02:17'),
...
export const sampleWithPartialData: IUser = {
  ...
  dateOfBirth: dayjs('2025-08-30'),
  createdAt: dayjs('2025-08-29T19:54'),
  updatedAt: dayjs('2025-08-29T18:47'),
...
export const sampleWithFullData: IUser = {
  ...
  dateOfBirth: dayjs('2025-08-30'),
  createdAt: dayjs('2025-08-30T08:42'),
  updatedAt: dayjs('2025-08-29T21:32'),
...
export const sampleWithNewData: NewUser = {
  ...
  lastName: 'Fisher',
  phoneNumber: 'yahoo',
  createdAt: dayjs('2025-08-30T09:38'),
  updatedAt: dayjs('2025-08-29T21:18'),
