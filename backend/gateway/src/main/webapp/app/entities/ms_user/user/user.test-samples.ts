...
export const sampleWithRequiredData: IUser = {
  ...
  createdAt: dayjs('2025-08-29T05:37'),
  updatedAt: dayjs('2025-08-29T13:05'),
...
export const sampleWithPartialData: IUser = {
  ...
  createdAt: dayjs('2025-08-29T06:42'),
  updatedAt: dayjs('2025-08-29T05:35'),
...
export const sampleWithFullData: IUser = {
  ...
  dateOfBirth: dayjs('2025-08-29'),
  createdAt: dayjs('2025-08-29T19:31'),
  updatedAt: dayjs('2025-08-29T08:20'),
...
export const sampleWithNewData: NewUser = {
  ...
  lastName: 'Fisher',
  phoneNumber: 'yahoo',
  createdAt: dayjs('2025-08-29T20:27'),
  updatedAt: dayjs('2025-08-29T08:06'),
