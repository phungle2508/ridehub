...
describe('Ticket Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'eb3780be-e8b0-469b-aaad-c64a11433994' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'f8b67745-9850-44fe-baf6-996539c3bdf0' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.tickets()[0]).toEqual(expect.objectContaining({ id: 'eb3780be-e8b0-469b-aaad-c64a11433994' }));
  });

  describe('trackId', () => {
    it('should forward to ticketService', () => {
      const entity = { id: 'eb3780be-e8b0-469b-aaad-c64a11433994' };
