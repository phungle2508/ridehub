...
export const sampleWithRequiredData: IBooking = {
  ...
  createdAt: dayjs('2025-08-29T13:59'),
  updatedAt: dayjs('2025-08-29T22:10'),
  expiresAt: dayjs('2025-08-29T14:17'),
};
...
export const sampleWithPartialData: IBooking = {
  ...
  createdAt: dayjs('2025-08-29T22:47'),
  updatedAt: dayjs('2025-08-29T11:49'),
  expiresAt: dayjs('2025-08-29T17:01'),
};
...
export const sampleWithFullData: IBooking = {
  ...
  updatedAt: dayjs('2025-08-29T19:35'),
  expiresAt: dayjs('2025-08-29T08:00'),
};
...
export const sampleWithNewData: NewBooking = {
  ...
  createdAt: dayjs('2025-08-29T09:55'),
  updatedAt: dayjs('2025-08-29T16:18'),
  expiresAt: dayjs('2025-08-29T12:41'),
  id: null,
};
