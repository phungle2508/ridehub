...
const requireRestSample: RestTicket = {
  ...
  reservedUntil: sampleWithRequiredData.reservedUntil?.toJSON(),
  ...
  describe('Service methods', () => {
    ...
    describe('compareTicket', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: 'eb3780be-e8b0-469b-aaad-c64a11433994' };
        const entity2 = null;
      ...
      it('should return false if primaryKey differs', () => {
        const entity1 = { id: 'eb3780be-e8b0-469b-aaad-c64a11433994' };
        const entity2 = { id: 'f8b67745-9850-44fe-baf6-996539c3bdf0' };
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: 'eb3780be-e8b0-469b-aaad-c64a11433994' };
        const entity2 = { id: 'eb3780be-e8b0-469b-aaad-c64a11433994' };
