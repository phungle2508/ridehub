...
export const sampleWithRequiredData: ITicket = {
  ...
  price: 29866.34,
  status: 'EXPIRED',
  createdAt: dayjs('2025-08-29T21:20'),
  updatedAt: dayjs('2025-08-29T03:03'),
};
...
export const sampleWithPartialData: ITicket = {
  ...
  price: 30556.66,
  status: 'CANCELLED',
  reservedUntil: dayjs('2025-08-29T07:27'),
  createdAt: dayjs('2025-08-29T03:10'),
  updatedAt: dayjs('2025-08-29T03:52'),
};
...
export const sampleWithFullData: ITicket = {
  ...
  price: 22086.89,
  status: 'EXPIRED',
  reservedUntil: dayjs('2025-08-29T20:33'),
  createdAt: dayjs('2025-08-29T05:51'),
  updatedAt: dayjs('2025-08-29T02:45'),
};
...
export const sampleWithNewData: NewTicket = {
  ...
  updatedAt: dayjs('2025-08-29T12:35'),
  id: null,
};
