...
/**
 * Criteria class for the {@link com.ridehub.route.domain.District} entity. This class is used
 * in {@link com.ridehub.route.web.rest.DistrictResource} to receive all the possible filtering options from
