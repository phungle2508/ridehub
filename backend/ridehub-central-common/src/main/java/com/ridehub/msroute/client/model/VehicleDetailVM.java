...
public class VehicleDetailVM {
  ...
  public VehicleDetailVM floors(@jakarta.annotation.Nullable List<FloorDTO> floors) {
  ...
  public VehicleDetailVM seatsByFloorId(@jakarta.annotation.Nullable Map<String, List<SeatDTO>> seatsByFloorId) {
    
    this.seatsByFloorId = seatsByFloorId;
    return this;
  }

  public VehicleDetailVM putSeatsByFloorIdItem(String key, List<SeatDTO> seatsByFloorIdItem) {
