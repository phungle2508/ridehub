...
public class FileUserTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static FileUser getFileUserSample1() {
        return new FileUser()
            .id(1L)
            .bucket("bucket1")
    ...
    public static FileUser getFileUserSample2() {
        return new FileUser()
            .id(2L)
            .bucket("bucket2")
    ...
    public static FileUser getFileUserRandomSampleGenerator() {
        return new FileUser()
